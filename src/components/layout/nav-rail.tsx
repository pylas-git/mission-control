...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'learning', label: 'Learning', icon: <EscpIcon />, priority: true, essential: true },
      { id: 'assessments', label: 'Assessments', icon: <EscpIcon />, priority: false, essential: true },
      { id: 'requests', label: 'Requests', icon: <EscpIcon />, priority: false, essential: true },
      { id: 'credits', label: 'Attribution', icon: <EscpIcon />, priority: false, essential: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'belts', label: 'Belts', icon: <EscpIcon />, priority: false },
      { id: 'requirements', label: 'Requirements', icon: <EscpIcon />, priority: false },
      { id: 'training', label: 'Training', icon: <EscpIcon />, priority: false },
